# Contributing to Awesome Small Business Automation

Awesome Small Business Automation is part of the Fox & Hen public tool set. Contributions should keep the project useful, inspectable, forkable, and safe to demonstrate in public.

## Good First Contributions

- Add or improve a synthetic sample scenario that demonstrates: A curated directory of practical automation tools, starter stacks, and open-source alternatives for small business workflows.
